  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-purple-600 overflow-hidden justify-between">
      <Head>
          ...
          <meta name="description" content="PRIDE is a coin powered by the community." />
          <meta name="keywords" content="PRIDE, a coin for all Lovers, cryptocurrency, community-powered" />
            ...
            <div className="mt-8">
              <div className="flex flex-wrap items-center justify-center md:justify-start">
                ...
                <Link href="https://www.tiktok.com/@pridetoken2" className='ml-2'>
                  <Image src='/tiktok.png' width={60} height={60} alt='tiktok'/>
                </Link>
                <Link href="https://youtube.com/@Pridetoken" className='ml-2'>
                  <Image src='/ytlogo.png' width={60} height={60} alt='youtube'/>
                </Link>
      ...
      <section className="bg-purple-600 py-16 min-h-screen w-screen relative justify-between flex-col items-center flex" id="about">
        ...
        <div className="container w-screen mx-auto flex flex-col min-h-screen md:pl-80 lg:pl-3/4 z-10 md:flex-col items-center justify-between px-6 max-w-screen-lg">
          <h2 className="text-4xl font-bold text-gray-100 mb-8 text-center">About $PRIDE</h2>
          ...
          <div className="flex flex-wrap justify-center">
            <div className="w-full md:w-full p-4 text-center">
              <h3 className="text-xl text-gray-100 font-bold mb-4">Our Mission</h3>
    ...
    <div className="container mx-auto px-6">
      <h2 className="text-4xl font-bold text-gray-100 mb-8 text-center">How to Buy PRIDE</h2>
    ...
    <div className="container flex-wrap justify-center mx-auto w-screen px-6">
      ...
      <h2 className="text-3xl font-bold mb-6 text-purple-900">💎 Sparkling Empowerment</h2>
        <p className="text-lg text-gray-200 mb-6">By investing in $Pride Token, you're embracing the power of financial empowerment. Let's break the chains of inequality and pave the way for a future where our community thrives in all its glorious colors.</p>

        <h2 className="text-3xl font-bold mb-6 text-purple-900">✨ Unleash Your Inner Superstar</h2>
        <p className="text-lg text-gray-200 mb-6">With $Pride Token, you're not just an investor, you're a star! Shine bright and show the world your true colors. Together, we'll create a symphony of acceptance, love, and unmatched fabulousness.</p>

        <h2 className="text-3xl font-bold mb-6 text-purple-900">🌟 Party with Purpose</h2>
        <p className="text-lg text-gray-200 mb-6">Every transaction with $Pride Token supports LGBTQ+ organizations, initiatives, and communities. We're here to party with a purpose, spreading joy and making a lasting impact. Let's turn the world into a dancefloor of equality!</p>

        <h2 className="text-3xl font-bold mb-6 text-purple-900">🎉 Be a Trailblazer</h2>
        <p className="text-lg text-gray-200 mb-6">You're not just following the crowd; you're leading the parade! Join our global community of trailblazers, rebels, and visionaries who are determined to redefine what's possible. Together, we'll challenge norms and create a more inclusive future.</p>

        <h2 className="text-3xl font-bold mb-6 text-purple-900">🔒 Safe & Sassy</h2>
        <p className="text-lg text-gray-200 mb-6">$Pride Token is backed by the ultra-secure Binance Smart Chain (BSC). Your investments are locked up tight, ensuring a worry-free journey through the fabulous crypto landscape. Safety and sassiness? It's a match made in rainbow heaven!</p>

        <h2 className="text-3xl font-bold mb-6 text-purple-900">💃 Strut Your Success</h2>
        <p className="text-lg text-gray-200 mb-6">As a $Pride Token holder, you're not just building wealth; you're strutting your success with pride. Get ready to sashay into financial abundance while making a difference. It's time to turn heads, break barriers, and conquer the world!</p>
...
*/}
    ...
    <div className='text-center w-screen bg-purple-600'>
      <div className='text-center w-full flex flex-col justify-center items-center'>
        <h1 className='font-aboreto text-gray-100 p-2 text-4xl font-bold'>OUR ROADMAP</h1>
        <p className='font-play-fair  text-gray-200 text-lg'>Here's a suggested roadmap for the $Pride Token project:</p>
        <div className='grid grid-cols-1 md:grid-cols-2 px-12 lg:grid-cols-3 gap-6 w-full'>
          <div className='flex flex-col justify-center items-center'>
            ...
            <h4 className='text-lg text-gray-200 mb-8'>Phase 1</h4>
            <ul className='text-left list-disc pl-6 text-lg text-gray-200 mb-8'>
          ...
          <div className='flex flex-col justify-center items-center'>
            ...
            <h4 className='text-lg text-gray-200 mb-8'>Phase 2</h4>
            <ul className='text-left list-disc pl-6 text-lg text-gray-200 mb-8'>
          ...
          <div className='flex flex-col justify-center items-center'>
            ...
            <h4 className='text-lg text-gray-200 mb-8'>Phase 3</h4>
            <ul className='text-left list-disc pl-6 text-lg text-gray-200 mb-8'>
          ...
          <div className='flex flex-col justify-center items-center'>
            ...
            <h4 className='text-lg text-gray-200 mb-8'>Phase 4</h4>
            <ul className='text-left list-disc pl-6 text-lg text-gray-200 mb-8'>
          ...
          <div className='flex flex-col justify-center items-center'>
            ...
            <h4 className='text-lg text-gray-200 mb-8'>Phase 5</h4>
            <ul className='text-left list-disc pl-6 text-lg text-gray-200 mb-8'>
      ...
      <section className="bg-purple-600 relative min-h-screen w-screen flex flex-col items-center justify-center" id="why-buy">
        <h2 className="text-3xl font-bold mb-6 text-gray-100">🌈 Tokenomics</h2>
        ...
        <h2 className="text-3xl font-bold mb-6 text-gray-100">🌈 Join the Fabulous Revolution</h2>
        <p className="text-lg mb-6 text-gray-200 px-12">Ready to unleash your inner diva? Invest in $Pride Token and be part of the most fabulous revolution the crypto world has ever seen. Let's celebrate love, diversity, and financial freedom like never before!</p>
